...
class AnswerViewController: UIViewController {
    ...
    func showAnswer() {
        ...
        let correctAnswerIndex = Int(currQuizAnswer[appData.currQuestionIndex].answer)!
        let correctAnswer = currQuizAnswer[appData.currQuestionIndex].answers[correctAnswerIndex - 1]
    ...
    func chooseSegue(){
        let currQuizAnswer = appData.quizzes[appData.topicIndex].questions
        question.text = currQuizAnswer[appData.currQuestionIndex].text
        if appData.currQuestionIndex + 1 < currQuizAnswer.count {
